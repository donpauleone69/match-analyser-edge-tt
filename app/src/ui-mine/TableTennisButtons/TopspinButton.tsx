/**
 * TopspinButton — Spin type: Topspin (upward arrow)
 */

import { TableTennisButtonBase, type ButtonSize } from './TableTennisButtonBase'

export interface TopspinButtonProps {
  onClick: () => void
  disabled?: boolean
  size?: ButtonSize
  className?: string
...
export function TopspinButton({ onClick, disabled, size = 'square', className }: TopspinButtonProps) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <line x1="50" y1="36" x2="50" y2="20" stroke="#FFD700" strokeWidth="2.5" strokeLinecap="round"/>
        <polyline points="44,25 50,19 56,25" stroke="#FFD700" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
        <text x="50" y="77" textAnchor="middle" fill="#fff" fontFamily="system-ui, sans-serif" fontSize="11" fontWeight="700">TOPSPIN</text>
      </svg>
    </TableTennisButtonBase>
  )
}
