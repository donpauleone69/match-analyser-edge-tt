/**
 * ShotButton — Blue button with "TAG SHOT" text
 */

import { TableTennisButtonBase, type ButtonSize } from './TableTennisButtonBase'

export interface ShotButtonProps {
  onClick: () => void
  disabled?: boolean
  size?: ButtonSize
  className?: string
...
export function ShotButton({ onClick, disabled, size = 'square', className }: ShotButtonProps) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <text x="50" y="66" textAnchor="middle" fill="#fff" fontFamily="system-ui, sans-serif" fontSize="14" fontWeight="700">SHOT</text>
      </svg>
    </TableTennisButtonBase>
  )
}
