...
export function LeftMidButton({ onClick, disabled, size = 'square', className }: LeftMidButtonProps) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <line x1="15" y1="88" x2="50" y2="12" stroke="#FFD700" strokeWidth="2.5" strokeLinecap="round"/>
        <polyline points="43,17 50,12 51,20" stroke="#FFD700" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    </TableTennisButtonBase>
  )
}
