/**
 * NoSpinButton — Spin type: No Spin (circle only)
 */

import { TableTennisButtonBase, type ButtonSize } from './TableTennisButtonBase'

export interface NoSpinButtonProps {
  onClick: () => void
  disabled?: boolean
  size?: ButtonSize
  className?: string
...
export function NoSpinButton({ onClick, disabled, size = 'square', className }: NoSpinButtonProps) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <text x="50" y="77" textAnchor="middle" fill="#fff" fontFamily="system-ui, sans-serif" fontSize="11" fontWeight="700">NO SPIN</text>
      </svg>
    </TableTennisButtonBase>
  )
}
