...
export function MidLeftButton({ onClick, disabled, size = 'square', className }: MidLeftButtonProps) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <line x1="50" y1="88" x2="15" y2="12" stroke="#FFD700" strokeWidth="2.5" strokeLinecap="round"/>
        <polyline points="14,20 15,12 22,17" stroke="#FFD700" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    </TableTennisButtonBase>
  )
}
