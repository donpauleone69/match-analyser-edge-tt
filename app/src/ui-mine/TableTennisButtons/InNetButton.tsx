/**
 * InNetButton — Blue top, Red bottom for shots that hit the net
 */

import { TableTennisButtonBase, type ButtonSize } from './TableTennisButtonBase'

export interface InNetButtonProps {
  onClick: () => void
  disabled?: boolean
  size?: ButtonSize
  className?: string
...
export function InNetButton({ onClick, disabled, size = 'square', className }: InNetButtonProps) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <text x="50" y="66" textAnchor="middle" fill="#fff" fontFamily="system-ui, sans-serif" fontSize="14" fontWeight="700">IN NET</text>
      </svg>
    </TableTennisButtonBase>
  )
}
