/**
 * RightMidButton — Direction: Right → Middle
 */

import { TableTennisButtonBase, type ButtonSize } from './TableTennisButtonBase'

export interface RightMidButtonProps {
  onClick: () => void
  disabled?: boolean
  size?: ButtonSize
  className?: string
...
export function RightMidButton({ onClick, disabled, size = 'square', className }: RightMidButtonProps) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" preserveAspectRatio="none" className="w-full h-full">
        ...
        <line x1="85" y1="88" x2="50" y2="12" stroke="#FFD700" strokeWidth="2.5" strokeLinecap="round"/>
        <polyline points="49,20 50,12 57,17" stroke="#FFD700" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    </TableTennisButtonBase>
  )
}
