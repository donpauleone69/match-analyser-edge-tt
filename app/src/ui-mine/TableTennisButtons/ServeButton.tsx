/**
 * ServeButton — Blue button with "TAG SERVE" text
 */

import { TableTennisButtonBase, type ButtonSize } from './TableTennisButtonBase'

export interface ServeButtonProps {
  onClick: () => void
  disabled?: boolean
  size?: ButtonSize
  className?: string
...
export function ServeButton({ onClick, disabled, size = 'square', className }: ServeButtonProps) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <text x="50" y="42" textAnchor="middle" fill="#fff" fontFamily="system-ui, sans-serif" fontSize="14" fontWeight="700">TAG</text>
        <text x="50" y="66" textAnchor="middle" fill="#fff" fontFamily="system-ui, sans-serif" fontSize="14" fontWeight="700">SERVE</text>
      </svg>
    </TableTennisButtonBase>
  )
}
