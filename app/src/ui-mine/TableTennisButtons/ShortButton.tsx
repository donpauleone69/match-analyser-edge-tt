/**
 * ShortButton — Serve depth: Short (yellow highlighted)
 */
...
export function ShortButton({ onClick, disabled, size = 'square', className }: ShortButtonProps) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <rect x="4" y="35" width="92" height="15" fill="#FFD700"/>
        ...
        <text x="50" y="77" textAnchor="middle" fill="#fff" fontFamily="system-ui, sans-serif" fontSize="11" fontWeight="700">SHORT</text>
      </svg>
    </TableTennisButtonBase>
  )
}
