/**
 * LeftRightButton — Direction: Left → Right
 */
...
export function LeftRightButton({ onClick, disabled, size = 'square', className }: LeftRightButtonProps) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <line x1="15" y1="88" x2="85" y2="12" stroke="#FFD700" strokeWidth="2.5" strokeLinecap="round"/>
        <polyline points="77,14 85,12 83,20" stroke="#FFD700" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    </TableTennisButtonBase>
  )
}
