/**
 * AverageQualityButton — Shot quality: Average (meh icon)
 */

import { TableTennisButtonBase, type ButtonSize } from './TableTennisButtonBase'

export interface AverageQualityButtonProps {
  onClick: () => void
  disabled?: boolean
  size?: ButtonSize
  className?: string
...
export function AverageQualityButton({ onClick, disabled, size = 'square', className }: AverageQualityButtonProps) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <path d="M10,4 L90,4 Q96,4 96,10 L96,50 L4,50 L4,10 Q4,4 10,4" fill="#9ca3af"/>
        <path d="M4,50 L96,50 L96,90 Q96,96 90,96 L10,96 Q4,96 4,90 Z" fill="#9ca3af"/>
        ...
        <line x1="43" y1="32" x2="57" y2="32" stroke="#FFD700" strokeWidth="2.5" strokeLinecap="round"/>
        {/* Text */}
        <text x="50" y="68" textAnchor="middle" fill="#fff" fontFamily="system-ui, sans-serif" fontSize="11" fontWeight="700">AVERAGE</text>
