/**
 * RightRightButton — Direction: Right → Right
 */

import { TableTennisButtonBase, type ButtonSize } from './TableTennisButtonBase'

export interface RightRightButtonProps {
  onClick: () => void
  disabled?: boolean
  size?: ButtonSize
  className?: string
...
export function RightRightButton({ onClick, disabled, size = 'square', className }: RightRightButtonProps) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <line x1="85" y1="88" x2="85" y2="12" stroke="#FFD700" strokeWidth="2.5" strokeLinecap="round"/>
        <polyline points="79,19 85,12 91,19" stroke="#FFD700" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    </TableTennisButtonBase>
  )
}
