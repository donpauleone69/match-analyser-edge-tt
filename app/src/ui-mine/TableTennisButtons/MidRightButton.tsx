/**
 * MidRightButton — Direction: Middle → Right
 */

import { TableTennisButtonBase, type ButtonSize } from './TableTennisButtonBase'

export interface MidRightButtonProps {
  onClick: () => void
  disabled?: boolean
  size?: ButtonSize
  className?: string
...
export function MidRightButton({ onClick, disabled, size = 'square', className }: MidRightButtonProps) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <line x1="50" y1="88" x2="85" y2="12" stroke="#FFD700" strokeWidth="2.5" strokeLinecap="round"/>
        <polyline points="78,17 85,12 86,20" stroke="#FFD700" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    </TableTennisButtonBase>
  )
}
