/**
 * ForcedErrorButton — Error type: Forced Error (grey, meh icon)
 */

import { TableTennisButtonBase, type ButtonSize } from './TableTennisButtonBase'

export interface ForcedErrorButtonProps {
  onClick: () => void
  disabled?: boolean
  size?: ButtonSize
  className?: string
...
export function ForcedErrorButton({ onClick, disabled, size = 'square', className }: ForcedErrorButtonProps) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        {/* Text */}
        <text x="50" y="68" textAnchor="middle" fill="#fff" fontFamily="system-ui, sans-serif" fontSize="11" fontWeight="700">FORCED</text>
