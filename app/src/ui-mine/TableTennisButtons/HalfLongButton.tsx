/**
 * HalfLongButton — Serve depth: Half-Long (yellow highlighted)
 */

import { TableTennisButtonBase, type ButtonSize } from './TableTennisButtonBase'

export interface HalfLongButtonProps {
  onClick: () => void
  disabled?: boolean
  size?: ButtonSize
  className?: string
...
export function HalfLongButton({ onClick, disabled, size = 'square', className }: HalfLongButtonProps) {
  return (
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <path d="M10,4 L90,4 Q96,4 96,10 L96,19.3 L4,19.3 L4,10 Q4,4 10,4" fill="#2563eb"/>
        <rect x="4" y="19.3" width="92" height="15.7" fill="#FFD700"/>
        ...
        <text x="50" y="77" textAnchor="middle" fill="#fff" fontFamily="system-ui, sans-serif" fontSize="11" fontWeight="700">HALF-LONG</text>
      </svg>
    </TableTennisButtonBase>
  )
}
