          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="text-xs text-neutral-500 mt-1">
                Best of {match.player1_sets_won + match.player2_sets_won + (match.match_result === 'completed' ? 0 : 1)}
              </div>
            </div>
            <div>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-2">
            {sets.map((set, idx) => {
              ...
              return (
                <div key={set.id} className="flex items-center justify-between p-4 bg-neutral-800 rounded-lg border border-neutral-700">
        ...
        <Card className="p-6">
          ...
          {rallies.length === 0 ? (
            ...
            <div className="space-y-2 max-h-96 overflow-y-auto">
              {rallies.map((rally) => (
                <div key={rally.id} className="flex items-center justify-between p-3 bg-neutral-800 rounded text-sm">
                  <span className="text-neutral-300">Rally {rally.rally_index}</span>
                  <div className="flex items-center gap-4">
                    <span className="text-neutral-400">{shots.filter(s => s.rally_id === rally.id).length} shots</span>
                    {rally.winner_id && (
          ...
          {shots.length === 0 ? (
            ...
            <>
              ...
              <div className="space-y-3 max-h-[600px] overflow-y-auto">
                {(() => {
                  // Create rally_id → rally_index mapping
